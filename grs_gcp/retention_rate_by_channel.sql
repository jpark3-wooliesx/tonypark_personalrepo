...
declare report_end date default current_date('Australia/Sydney')-1;
...
--[Manual] Weekly: Retention Rate by Custom Insurance Segments
with
date_range as (
  select
...
--[Manual] Monthly: Retention Rate by Custom Insurance Segments
with
date_range as (
  select
